        ...
        <section class="bg-dashboard">
            <div class="container-fluid">
                                        ...
                                        <tbody>
                                            <?php 
                                             ...
                                             foreach ($land_data as $row) {
                                                ...
                                                <td class="p-3">
                                                <iframe src="'.$row['site_plan'].'" width="90%" height="100"></iframe>
                                                </td>
                ...
                <td class="text-end p-3">
                    ...
                    <a href="upload_plan.php?id='.$row['id'].'" class="btn btn-icon btn-pills btn-soft-success"><i class="uil uil-check-circle"></i></a>
