...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/patient-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 21:07:26 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-12">
                        <div class="card border-0 p-4 rounded shadow overflow-hidden sticky-bar">
                            <div class="d-md-flex text-center text-md-start align-items-center">
                                <img src="../assets/images/client/09.jpg" class="avatar avatar-md-md rounded-circle border shadow" alt="">
                            ...
                            <ul class="list-unstyled mb-0 mt-4">
                                <li class="list-inline-item"><a href="#"><img src="../assets/images/doctors/01.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt=""></a></li>
                                <li class="list-inline-item"><a href="#"><img src="../assets/images/doctors/02.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt=""></a></li>
                                <li class="list-inline-item"><a href="#"><img src="../assets/images/doctors/03.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt=""></a></li>
                                <li class="list-inline-item"><a href="#"><img src="../assets/images/doctors/04.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt=""></a></li>
                                <li class="list-inline-item"><a href="#"><img src="../assets/images/doctors/05.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt=""></a></li>
                            </ul>

                            <h6 class="mt-4 mb-0">Payments:</h6>
                            <ul class="list-unstyled mb-0 mt-4">
                                <li class="d-flex align-items-center">
                                    <img src="../assets/images/payment/mastercard.png" class="avatar avatar-md-sm" alt="">
                                ...
                                <li class="d-flex align-items-center mt-3">
                                    <img src="../assets/images/payment/discover.png" class="avatar avatar-md-sm" alt="">
                                    <div class="flex-1 ms-3">
                                ...
                                <li class="d-flex align-items-center mt-3">
                                    <img src="../assets/images/payment/rupay.png" class="avatar avatar-md-sm" alt="">
                                    <div class="flex-1 ms-3">
                                ...
                                <li class="d-flex align-items-center mt-3">
                                    <img src="../assets/images/payment/american.png" class="avatar avatar-md-sm" alt="">
                                    <div class="flex-1 ms-3">
        ...
        <script src="../assets/js/radialchartinit.js"></script>
        <!-- simplebar -->
...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/patient-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 21:07:29 GMT -->
</html>