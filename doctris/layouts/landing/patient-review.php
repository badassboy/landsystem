...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/patient-review.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 21:07:24 GMT -->
<head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="mt-4">
                                        <div class="progress-box">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="progress-value d-block text-muted h6">5 Star</div></div>
                                            <div class="progress">
                                        ...
                                        <div class="progress-box mt-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="progress-value d-block text-muted h6">4 Star</div></div>
                                            <div class="progress">
                                        ...
                                        <div class="progress-box mt-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="progress-value d-block text-muted h6">3 Star</div></div>
                                            <div class="progress">
                                                <div class="progress-bar position-relative bg-primary" style="width:10%;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="progress-box mt-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="progress-value d-block text-muted h6">2 Star</div></div>
                                            <div class="progress">
                                        ...
                                        <div class="progress-box mt-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="progress-value d-block text-muted h6">1 Star</div></div>
                                            <div class="progress">
                                                <div class="progress-bar position-relative bg-primary" style="width:5%;">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-md-6">
                                            <div class="text-center">
                                                ...
                                                <h6 class="text-primary mt-3">- Howard Tanner <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4 mt-sm-0">
                                            <div class="text-center">
                                                <img src="../assets/images/client/02.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                                <h6 class="text-primary mt-3">- Wendy Filson <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4 mt-lg-0">
                                            <div class="text-center">
                                                <img src="../assets/images/client/03.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                                <h6 class="text-primary mt-3">- Faye Bridger <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4">
                                            <div class="text-center">
                                                ...
                                                <h6 class="text-primary mt-3">- Ronald Curtis <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4">
                                            <div class="text-center">
                                                ...
                                                <h6 class="text-primary mt-3">- Melissa Hibner <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4">
                                            <div class="text-center">
                                                ...
                                                <h6 class="text-primary mt-3">- Randall Case <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4">
                                            <div class="text-center">
                                                <img src="../assets/images/client/07.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                                <h6 class="text-primary mt-3">- Jerry Morena <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                        ...
                                        <div class="col-xl-4 col-md-6 mt-4">
                                            <div class="text-center">
                                                <img src="../assets/images/client/08.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                                <h6 class="text-primary mt-3">- Lester McNally <small class="text-muted">C.E.O</small></h6>
                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. "</p>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
