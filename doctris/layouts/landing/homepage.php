                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-left nav-light">
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            <a href="javascript:void(0)">Chief Caretaker</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li class="has-submenu parent-menu-item">
                                    <a href="javascript:void(0)" class="menu-item"> Dashboard </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li><a href="doctor-dashboard.php" class="sub-menu-item">Dashboard</a></li>
                                        <li><a href="doctor-appointment.php" class="sub-menu-item">Appointment</a></li>
                                        <li><a href="patient-list.php" class="sub-menu-item">Patients</a></li>
                                        <li><a href="doctor-schedule.php" class="sub-menu-item">Schedule Timing</a></li>
                                        <li><a href="invoices.php" class="sub-menu-item">Invoices</a></li>
                                        <li><a href="patient-review.php" class="sub-menu-item">Reviews</a></li>
                                        <li><a href="doctor-messages.php" class="sub-menu-item">Messages</a></li>
                                        <li><a href="doctor-profile.php" class="sub-menu-item">Profile</a></li>
                                        <li><a href="doctor-profile-setting.php" class="sub-menu-item">Profile Settings</a></li>
                                        <li><a href="doctor-chat.php" class="sub-menu-item">Chat</a></li>
                                        <li><a href="login.php" class="sub-menu-item">Login</a></li>
                                        <li><a href="signup.php" class="sub-menu-item">Sign Up</a></li>
                                        <li><a href="forgot-password.php" class="sub-menu-item">Forgot Password</a></li>
                                    </ul>
                                </li>

                                <!-- <li><a href="doctor-team-one.php" class="sub-menu-item">Doctors One</a></li>
                                <li><a href="doctor-team-two.php" class="sub-menu-item">Doctors Two</a></li>
                                <li><a href="doctor-team-three.php" class="sub-menu-item">Doctors Three</a></li> -->
                            </ul>
                        </li>

                        <li class="has-submenu parent-menu-item">
                            <a href="javascript:void(0)">District Assembly</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li><a href="patient-dashboard.php" class="sub-menu-item">Dashboard</a></li>
                                <li><a href="patient-profile.php" class="sub-menu-item">Profile</a></li>
                                <li><a href="booking-appointment.php" class="sub-menu-item">Book Appointment</a></li>
                                <li><a href="patient-invoice.php" class="sub-menu-item">Invoice</a></li>
                            </ul>
                        </li>

                         <li class="has-submenu parent-menu-item">
                            <a href="javascript:void(0)">Supreme Chief</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li><a href="patient-dashboard.php" class="sub-menu-item">Dashboard</a></li>
                                <li><a href="patient-profile.php" class="sub-menu-item">Profile</a></li>
                                <li><a href="booking-appointment.php" class="sub-menu-item">Book Appointment</a></li>
