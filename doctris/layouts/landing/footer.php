<footer class="bg-footer">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-8 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <h5 class="text-light title-dark footer-head">Services</h5>
                                <ul class="list-unstyled footer-list mt-4">
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>Custom Development</a></li>
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>Enterprise Development</a></li>
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>App Development</a></li>
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>Web Design</a></li>
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>Data Science</a></li>
                                    <li><a href="" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>Netwoking & Cybersecurity</a></li>
        ...
        <li class="d-flex align-items-center">
            ...
            <a href="mailto:contact@example.com" class="text-foot ms-2">cloudsofttechnology8@gmail.com</a>
        </li>

                                    <li class="d-flex align-items-center">
                                        <i data-feather="phone" class="fea icon-sm text-foot align-middle"></i>
                    <a href="tel:+152534-468-854" class="text-foot ms-2">+233545804166</a>
                                    </li>
