...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/doctor-team-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 21:07:26 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <div class="section-title text-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-3">
                                <ul class="breadcrumb bg-transparent mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Team three</li>
                                </ul>
                            </nav>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <div class="card team border-0 rounded shadow overflow-hidden">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="team-person position-relative overflow-hidden">
